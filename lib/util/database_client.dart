...
class DatabaseHelper {
  ...
  final String columnItemContent = "itemContent";
  ...
  void _onCreate(Database db, int version) async {
    await db.execute(
        "CREATE TABLE $tableName(id INTEGER PRIMARY KEY, $columnItemName TEXT, $columnItemContent TEXT, $columnDateCreated TEXT)");
...
//insertion
  ...
  Future<List> getItems() async {
    ...
    var result = await dbClient.rawQuery(
        "SELECT * FROM $tableName ORDER BY $columnDateCreated DESC"); //ASC
